...
2. Copy and paste the following two pieces of code into your "RMarkdown Practice" document (include the gray code "chunks").      
...
3. Now `knit` the file to html using the knit button at the top of the page.  
4. Lastly, commit and push this file to your GitHub repository.  
