...
ui <- fluidPage(
    ...
    plotOutput("plot", width="500px", height="400px") #providing plot size/aspect
)
...
Congratulations, you made your first shiny app! <- WAHOOO
...
ui <- fluidPage(
    ...
    selectInput("fill", "Fill by", choices = c("trophic.guild", "thermoregulation"), 
...
server <- function(input, output) {
  ...
  output$plot <- renderPlot({
      ...
      ggplot(data=homerange, aes_string(x="locomotion", fill=input$fill))+
